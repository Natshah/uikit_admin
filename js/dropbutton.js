/**
 * @file
 * Override of core dropbutton feature.
 */
  ...
  Drupal.behaviors.dropButton = {
    attach: function (context, settings) {
      ...
      if ($dropbuttons.length) {
        ...
        for (var i = 0; i < il; i++) {
          $dropbuttons.each(function (index, element) {
            if ($(element).hasClass('dropbutton-single')) {
              //$dropbuttons.splice($.inArray(index, $dropbuttons),1);
            }
          });
